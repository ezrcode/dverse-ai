...
const translations: Record<Lang, Record<string, string>> = {
    es: {
        ...
        chat_emptySubtitle: 'Selecciona un entorno de Dynamics 365 y comienza a preguntar sobre tu metadata de Dataverse',
        chat_selectEnvFirst: 'Primero selecciona un entorno',
        // Environments
        env_title: 'Entornos de Dynamics 365',
        env_subtitle: 'Administra tus conexiones a Dataverse',
        env_selectPlaceholder: 'Selecciona un entorno...',
        ...
        env_noConfigured: 'No hay entornos configurados.',
        env_configureFirst: 'Configura tu primer entorno',
        ...
        env_selectAll: 'Seleccionar todos',
        env_compareMultiple: 'Comparar múltiples entornos',
        env_comparisonMode: 'Modo comparación activo',
        env_more: 'más',
        env_help_title: 'Cómo obtener estas credenciales',
        env_help_1: 'Ve a Azure Portal → Azure Active Directory → App registrations',
        env_help_2: 'Crea un nuevo App registration o selecciona uno existente',
        env_help_3: 'Copia el Application (client) ID y Directory (tenant) ID',
        env_help_4: 'Ve a Certificates & secrets → Crea un nuevo client secret',
        env_help_5: 'Concede permisos API para Dynamics CRM (user_impersonation)',
        // Landing
    ...
    en: {
        ...
        chat_emptySubtitle: 'Select a Dynamics 365 environment and start asking questions about your Dataverse metadata',
        chat_selectEnvFirst: 'Please select an environment first',
        // Environments
        env_title: 'Dynamics 365 Environments',
        env_subtitle: 'Manage your Dataverse connections',
        env_selectPlaceholder: 'Select an environment...',
        ...
        env_noConfigured: 'No environments configured.',
        env_configureFirst: 'Configure your first environment',
        ...
        env_selectAll: 'Select all',
        env_compareMultiple: 'Compare multiple environments',
        env_comparisonMode: 'Comparison mode active',
        env_more: 'more',
        env_help_title: 'How to get these credentials',
        env_help_1: 'Go to Azure Portal → Azure Active Directory → App registrations',
        env_help_2: 'Create a new app registration or select an existing one',
        env_help_3: 'Copy the Application (client) ID and Directory (tenant) ID',
        env_help_4: 'Go to Certificates & secrets → Create a new client secret',
        env_help_5: 'Grant API permissions for Dynamics CRM (user_impersonation)',
        // Landing
